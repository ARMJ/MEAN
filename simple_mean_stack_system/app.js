...
app.use('/typography', express.static(path.join(__dirname, 'dist')));
app.use('/icons', express.static(path.join(__dirname, 'dist')));
app.use('/maps', express.static(path.join(__dirname, 'dist')));
app.use('/notifications', express.static(path.join(__dirname, 'dist')));
app.use('/upgrade', express.static(path.join(__dirname, 'dist')));
